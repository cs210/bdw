...
/*!
 @method tableCellWithInteger:
 @abstract Create a table cell that contains an integer identifier.
 @discussion This method should be used to initialize the ID column cells (column 0) of bookmarkable tables.
 The IDs to be used with functional bookmarks must be 24 bit integer values.
 @param integer The number that should be saved in the cell.
 @return An instance of IDTableCell or nil if table cell could not be created.
 */
+(IDTableCell*)tableCellWithInteger:(NSInteger)integer;
