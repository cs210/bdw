...
/*!
 ...
 @constant IDVehicleHmiVersion1411      November 2014 release.
 @constant IDVehicleHmiVersion1503      March 2015 release.
 @constant IDVehicleHmiVersion1507      July 2015 release.
 */
typedef enum  {
    ...
    IDVehicleHmiVersion1411 = 15,
    IDVehicleHmiVersion1503 = 16,
    IDVehicleHmiVersion1507 = 17
} IDVehicleHmiVersion;
...
/*!
 @property A4AXLSupported
 @abstract Flag indicating wether the connected vehicle supports A4AXL.
 */
@property (assign, readonly, getter=isA4AXLSupported) BOOL A4AXLSupported;

/*!
 @property A4AXLSupported
 @abstract Flag indicating wether the connected vehicle supports Speed Lock.
 */
@property (assign, readonly, getter=isSpeedLockSupported) BOOL speedLockSupported;

/*!
 @property A4AXLSupported
 @abstract Flag indicating wether the connected vehicle supports Navigation.
 */
@property (assign, readonly, getter=isNaviSupported) BOOL naviSupported;

/*!
 @property A4AXLSupported
 @abstract Flag indicating wether the connected vehicle supports Profile Import Assistant (PIA).
 */
@property (assign, readonly, getter=isPIASupported) BOOL PIASupported;

/*!
 @property A4AXLSupported
 @abstract Flag indicating wether the connected vehicle supports Text-to-Speech (TTS).
 */
@property (assign, readonly, getter=isTTSSupported) BOOL TTSSupported;

/*!
 @property A4AXLSupported
 @abstract Flag indicating wether the connected vehicle supports Speech-to-Text (STT).
 */
@property (assign, readonly, getter=isSTTSupported) BOOL STTSupported;
