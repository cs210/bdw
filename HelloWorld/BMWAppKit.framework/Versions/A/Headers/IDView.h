 ...
 */
- (instancetype)initWithHmiState:(NSInteger)hmiState titleModel:(IDModel *)titleModel focusEvent:(NSInteger)focusEvent;
 ...
 */
@property (nonatomic, weak, readonly) IDApplication *application;
...
/*!
 ...
 @discussion <#This is a more detailed description of the property.#>
 */
@property (nonatomic, weak) id<IDViewDelegate> delegate;
