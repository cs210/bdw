 ...
 */
- (instancetype)initWithWidgetId:(NSInteger)widgetId model:(IDModel *)model imageModel:(IDModel *)imageModel targetModel:(IDModel *)targetModel actionId:(NSInteger)actionId focusId:(NSInteger)focusId;
 ...
 */
@property (nonatomic, strong) IDImageData *image;
