...
/*!
 ...
 @discussion Represents a filter button. I.e. a button which can be used to request some input from the user. When focussed in the HMI the text of this button is updated to display the tooltip text followed by a '?' sign and the currently set value of the text property.
...
/*!
 @property tooltipText Set the tooltip text of a filter button.
...
/*!
 @property tooltipTextId Set the text ID for a filter button's tooltip text.
