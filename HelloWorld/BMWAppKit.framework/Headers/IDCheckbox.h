 ...
 */
- (instancetype)initWithWidgetId:(NSInteger)widgetId model:(IDModel *)model textModel:(IDModel *)textModel actionId:(NSInteger)actionId style:(IDCheckboxStyle)style;
 ...
 */
@property (nonatomic, readonly) IDCheckboxStyle style;
 ...
 */
@property (nonatomic, weak) id<IDCheckboxDelegate> delegate;
