...
@interface GroundStationTestViewController ()

@end

@implementation GroundStationTestViewController
...
- (void)viewDidLoad
{
    ...
    self.statusView = [[GroundStationStatusView alloc] initWithNib];
...
-(void) groundStation:(id<DJIGroundStation>)gs didUpdateFlyingInformation:(DJIGroundStationFlyingInfo*)flyingInfo
{
    ...
    [status appendFormat:@"Satellite: %d\n", flyingInfo.satelliteCount];
    [status appendFormat:@"Speed X: %f\n", flyingInfo.velocityX];
    [status appendFormat:@"Speed Y: %f\n", flyingInfo.velocityY];
    [status appendFormat:@"Speed Z: %f\n", flyingInfo.velocityZ];
    [status appendFormat:@"Attitude Pitch: %f\n", flyingInfo.attitude.pitch];
    [status appendFormat:@"Attitude Roll: %f\n", flyingInfo.attitude.roll];
    [status appendFormat:@"Attitude Yaw: %f\n", flyingInfo.attitude.yaw];
    [status appendFormat:@"Height: %f\n", flyingInfo.altitude];
    [status appendFormat:@"DroneStatus: %d\n", (int)flyingInfo.droneStatus];
    
    [self.statusView updateStatus:status];
}
