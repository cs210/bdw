...
#import "CameraSettingsView.h"

@interface CameraTestViewController : UIViewController<DJIDroneDelegate, DJICameraDelegate, DJIMainControllerDelegate>
{
    DJIDrone* _drone;
    UIView* videoPreviewView;
    CameraSettingsView* _settingsView;
