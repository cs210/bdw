...
@interface BatteryTestViewController ()

@end

@implementation BatteryTestViewController
...
-(void) onReadBatteryInfoTimerTicked:(id)timer
{
    [_drone.smartBattery updateBatteryInfo:^(DJIError *error) {
        if (error.errorCode == ERR_Successed) {
            ...
            [batteryInfoString appendFormat:@"chargeCount = %ld",(long)_drone.smartBattery.dischargeCount];
