 ...
 */
+ (instancetype)imageDataWithURL:(NSURL *)imageURL;
...
@property (nonatomic, assign, readonly) CGSize imageSize; // not KVO compliant
@property (nonatomic, strong, readonly) NSData *imageData; // not KVO compliant
